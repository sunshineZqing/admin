		...
		<div class="renzheng-info">
			...
			<div class="renzheng-content">
				...
				<div class="renzheng-item">
					<tabpanel :name="currentname" ></tabpanel>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	export default {
		...
		methods:{
            ...
            toggleclick(name,ordernum,au_id,au_num){
            	let lastname     = this.lastname
            	this.currentname = name
            	if((lastname=='operator'||lastname=='holographic')&&ordernum=='16'){
            		return 
            	}
                this.getauthiteminfo(ordernum,au_id,au_num)
            },
            getauthiteminfo(ordernum ='12',au_id = '17',au_num = '200'){
