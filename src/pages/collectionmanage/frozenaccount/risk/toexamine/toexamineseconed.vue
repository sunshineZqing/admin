		...
		<div class="examinepad">
		    ...
		    <el-form ref="form1" :model="form1" label-width="80px">
			 ...
			 <!--    <el-form-item label="性别" prop="gender">
			    ...
			    <el-form-item label="电话" prop="phone">
		    	    <el-input v-model="form1.phone" :disabled="true" type="text"  placeholder="电话"></el-input>
			    </el-form-item>			    
		    ...
		    <el-form ref="form2" :model="form2" label-width="80px" :rules="rules" >
		    	<el-form-item label="复审建议"  prop="advise" >
		    	    <el-input  v-model="form2.advise"  :disabled='true' @blur="saveAdvise"  type="textarea" :rows='row' placeholder="复审建议"></el-input>
			    </el-form-item>
			    <el-form-item label="复审额度"  prop="money"  >
		    	    <el-input v-model.number="form2.money" :disabled='true'    type="text"  placeholder="复审额度"></el-input>
			    </el-form-item>
			    <el-form-item label="初审评分"  prop="score">
		    	    <el-input v-model.number="form2.score" :disabled='true'  type="text"  placeholder="初审评分"></el-input>
			    </el-form-item>
			    <el-form-item >
		    	    <el-input v-model="form2.mark" type="textarea" :disabled='true'   :rows='row' placeholder="评分备注"></el-input>
			    </el-form-item>
...
//			...mapGetters(['params'])
		...
		mounted(){
			...
			if(!isEmptyObject(this.params)&&this.params[1].ynumPd&&this.params[1].ynumPd.auditflag){
				console.log(this.params[1].ynumPd)
