	    ...
	    <div v-show="isshow" class="origininfo" v-loading="contantload">
		    <el-tabs v-model="activeName" @tab-click="handleClick">
				<el-tab-pane v-for="item in roleList" :label="item.name" :name="item.name" :key="item.name">
					...
					<div v-show="item.name=='消费分析'" style="width:60%;">
					...
					<div v-show="item.name=='通话详情'" style="width:70%;">
					...
					<div v-show="item.name=='通话详情统计'" style="width:60%;">
					...
					<div v-show="item.name=='通话统计'" style="width:60%;" v-if="usertype==0">
...
<script>
	...
	export default {
		...
		components: { basetable,basepage,origintable },
		props:{
