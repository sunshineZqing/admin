<template>
	<div class="loanrecoverystatistics">
		<el-form :inline="true" :model="loanrecoveryParams" class="demo-form-inline" align="left">
			...
			<el-form-item>
				<el-button type="primary" size="medium" @click="loanrecoveryList">查询</el-button>
			</el-form-item>
			<a class="download" :href="'/ykj/statistics/loanH5Excel.do?wantday='+loanrecoveryParams.wantday+'&Today='+loanrecoveryParams.Today" target="_blank">下载</a>
...
<script>
	...
	export default{
		...
		methods:{
			loanrecoveryList(){
				this.$api.loanrecoveryList(this.loanrecoveryParams).then(res => {}, response => {
